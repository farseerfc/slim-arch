...
source=(http://download.berlios.de/$pkgname/$pkgname-$pkgver.tar.gz
        ...
        slim-1.3.6-add-sessions-back.patch
        slim.pam
        slim.logrotate)
sha256sums=('21defeed175418c46d71af71fd493cd0cbffd693f9d43c2151529125859810df'
            ...
            '77935e5008db4f8c20dcb87bdfc2a090f2a1146e89d7915411390f6548ffd7c6'
...
prepare() {
  ...
  patch -Np1 -i "$srcdir/slim-1.3.6-add-sessions-back.patch"
}
